package com.cgvsu.triangle_rasterisation.rasterisers;

import com.cgvsu.triangle_rasterisation.color.Texture;
import com.cgvsu.triangle_rasterisation.Baricentrics_Triangle.Triangle;
...
public class TriangleRasterisator {
    ...
    public void draw(Point2D p1, double z1, Point2D p2, double z2, Point2D p3, double z3,
        ...
        if (Utils.equals(v1.getY(), v2.getY())) {
