...
public class GradientTexture implements Texture {
    ...
    private double red(final Barycentric b) {
        ...
        return Utils_for_trianglerasterisation.confined(0, r1 + r2 + r3, 1);
    }
    ...
    private double green(final Barycentric b) {
        ...
        return Utils_for_trianglerasterisation.confined(0, g1 + g2 + g3, 1);
    }
    ...
    private double blue(final Barycentric b) {
        ...
        return Utils_for_trianglerasterisation.confined(0, b1 + b2 + b3, 1);
    }
    ...
    private double opacity(final Barycentric b) {
        ...
        return Utils_for_trianglerasterisation.confined(0, o1 + o2 + o3, 1);
    }
