...
import com.cgvsu.Utils.color_for_triangle_rasterisation.GradientTexture;
 ...
 */
public class Test_triangle_pasteurisation_poka_ne_trogati extends Application {
...
//        tr.draw(p1, p2, p3, gt);
    ...
    public void start(Stage scene) throws Exception {
        ...
        scene.setTitle("Test_triangle_pasteurisation_poka_ne_trogati");
